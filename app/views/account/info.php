								...
								<div class="d-flex flex-row">
										...
										<div class="card card-custom card-stretch">
											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?=$this->getInput()->firstname?> <?=$this->getInput()->lastname?></a>
												...
												<div class="py-9">
													<div class="d-flex align-items-center justify-content-between mb-2">
														...
														<a href="#" class="text-muted text-hover-primary"><?=$this->getInput()->email?></a>
													</div>
													<div class="d-flex align-items-center justify-content-between mb-2">
												...
												<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
													...
													<div class="navi-item mb-2">
														<a href="<?=PROOT?>account/changePass" class="navi-link py-4">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
									...
									<div class="flex-row-fluid ml-lg-8">
										...
										<div class="card card-custom">
											...
											<!--end::Header-->
											<!--begin::Form-->
											<form class="form" method="POST" action="<?=PROOT?>account/updateFields">
												<div class="card-body">
													<!--begin::Heading-->
													<div class="row">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<div class="input-group input-group-lg input-group-solid">
																...
																<input type="email" name="email" class="form-control  form-control-lg form-control-solid" value="<?=$this->getInput()->email?>" placeholder="Email" />
															</div>
													...
													<label class="col-xl-3 col-lg-3 col-form-label">Telephone</label>
														<div class="col-lg-9 col-xl-6">
																...
																<input class="form-control form-control-lg form-control-solid" type="phone" name='phone' value="" />
							
														</div>
													</div>
                                                   
													<input  value="Save Changes" type="submit"  class="btn btn-success mr-2" />
