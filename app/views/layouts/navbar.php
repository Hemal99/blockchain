<div id="kt_header" class="header bg-white header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-stretch mr-2">
								<!--begin::Page Title-->
								<h3 class="d-none text-dark d-lg-flex align-items-center mr-10 mb-0"><?=$this->siteTitle();?></h3>
								<!--end::Page Title-->
								...
								<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
										...
										<ul class="menu-nav">
                                            ...
                                            ?>
											<li class="menu-item menu-item-<?php echo "{$val_1}";?>" aria-haspopup="true">
                                                
												<a href="<?=PROOT?>dashboard" class="menu-link">
													<span class="menu-text">Dashboard</span>
												</a>
											</li>
											<li class="menu-item menu-item-submenu menu-item-<?php echo "{$val_2}"?> data-menu-toggle="click" aria-haspopup="true">
												<a href="<?=PROOT?>account" class="menu-link">
								...
								<div class="topbar-item">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										<div class="d-flex flex-column text-right pr-3">
											<span class="text-muted font-weight-bold font-size-base d-none d-md-inline"><?=Users::currentUser()->firstname?></span>
