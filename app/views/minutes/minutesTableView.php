                            ...
                            <div class="card card-custom gutter-b">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Minutes</span>
                                                
                                            </h3>
                                            <div class="card-toolbar">
                                                <a href="<?=PROOT?>Minute/addMinute" class="btn btn-info font-weight-bolder font-size-sm">Add Minute</a>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
