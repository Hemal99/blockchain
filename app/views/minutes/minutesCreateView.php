								...
								<div class="d-flex flex-row">
									...
									<div class="flex-row-fluid ml-lg-8">
										...
										<div class="card card-custom">
											...
											<!--end::Header-->
											<!--begin::Form-->
											<form id='form1' class="form" method="POST" action="<?=PROOT?>minute/insertField">
												<div class="card-body">
													<!--begin::Heading-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-12 col-xl-12">
                                                                        <input class="form-control form-control-lg form-control-solid" required  type="text" name='title'  />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
																...
																<div class="checkbox-list">
																		<?php $res = $this->getInput();
																		  ...
																		  <label class="checkbox">
																			<?php $check=Users::currentUser()->id;
																			if($check==$val->id) :
																			?>
																			<input type="checkbox"  name="name[]" value="<?php echo $val->id?>" checked/>
																			<?php else: ?>
																			<input type="checkbox"  name="name[]" value="<?php echo $val->id?>"/>
                                                        ...
                                                        <div class="card card-custom  col-xl-12 col-lg-3">
                                                            ...
                                                            <!-- <div class="card-body">
                                                                ...
                                                                <div id="kt_quil_1" style="height: 325px">
                                                                   <textarea name='agenda' form="form1"></textarea>
                                                                </div>
															
                                                            </div> -->
															<textarea  name='agenda' form="form1" rows='4'></textarea>
                                                        </div>
                                                    ...
                                                    <div class= "row">
                                                        <div class="card card-custom  col-xl-12 col-lg-3">
															...
															<textarea name='action' form="form1" rows="4"></textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="form-group row">
                                                                <label class="col-xl-12 col-lg-3 col-form-label">Date</label>
                                                                <div class="col-lg-12 col-xl-12">
                                                                        <input class="form-control form-control-lg form-control-solid" required  type="date" name='date'  />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?=$this->getInput()->name?></a>
